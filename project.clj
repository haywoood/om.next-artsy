(defproject art "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "art.core/on-figwheel-reload"}

                :compiler {:main art.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/art.js"
